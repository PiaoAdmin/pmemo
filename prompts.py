...
GENERATE_SYSTEM_RESPONSE_USER_PROMPT = (
    ...
    "{history_text}\n\n"
    "<MEMORY>\n"
    "The memories linked to the ongoing conversation are organized as:\n"
    "1) Key Memory 2) Long-Term Summary 3) Mid-Term Memory 4) Short-Term Memory.\n"
    "Always prioritize Key Memory when conflicts exist.\n"
    "Deleted memories are not valid evidence.\n"
    "Memory detail:\n"
    "{retrieval_text}\n\n"
    "<USER TRAITS>\n"
